            ...
            <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  className="relative aspect-[16/9] sm:aspect-video rounded-lg sm:rounded-xl border-2 border-dashed border-gray-300 hover:border-amber-500 transition-colors cursor-pointer overflow-hidden bg-gray-50"
                >
                  {imagePreview ? (
                    <Image
                      src={imagePreview}
