...
export default function Footer() {
  ...
  const contactInfo = [
    ...
    { icon: Clock, text: "Site: 24/24 | Magazin: Luni-Vineri 09:00-19:00, Sâmbătă-Duminică 10:00-18:00" },
  ];

  const socialLinks = [
    { icon: Instagram, href: "https://www.instagram.com/nutopia.md?igsh=NDgwYnUyY2w1MWht&utm_source=qr", label: "Instagram" },
    { icon: Facebook, href: "https://www.facebook.com/share/1Dgz3VwfVR/?mibextid=wwXIfr", label: "Facebook" },
    { icon: null, href: "https://www.tiktok.com/@nucifructeuscate?_r=1&_t=ZM-92Su8RLapEB", label: "TikTok", isTikTok: true },
  ];
